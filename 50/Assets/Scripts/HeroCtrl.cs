    ...
    void FireUpdate()
    {
        ...
        if (m_ShootCool <= 0.0f)
        {
            ...
            if (0.0f < m_DoubleOnTime)
            {
                ...
                Sound_Mgr.Inst.PlayEffSound("gun", 0.2f);
            }
            ...
            Sound_Mgr.Inst.PlayEffSound("gun", 0.1f);
        }
    ...
    void OnTriggerEnter2D(Collider2D coll)
    {
        ...
        else if (coll.tag == "EnemyBullet")
        {
            ...
            Game_Mgr.Inst.DecreaseGold(10);
               ...
               Bullet_Ctrl a_BulletSc = coll.gameObject.GetComponent<Bullet_Ctrl>();

                if (a_BulletSc.m_IsPool == true)
